...
import { FaPython, FaAws, FaGitAlt, FaDatabase, FaBrain, FaCogs } from 'react-icons/fa';
import { BiMessageSquareDetail, BiStats } from 'react-icons/bi';
import { TbBrandCpp, TbBrandOpenai, TbBrandPython } from 'react-icons/tb';
...
function Home() {
  ...
  const skills = [
    ...
    { skill: "Computer Vision", icon: FaBrain },
    ...
    <div className="min-h-screen">
      ...
      <section className="min-h-screen grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center p-8 md:p-16 lg:p-24">
          <h1 className="text-6xl md:text-7xl font-bold mb-6 tracking-tight leading-none text-center">
        ...
        <div className="flex flex-col items-center justify-center p-8 md:p-16">
          <div className="relative perspective-1000 mb-6">
            <div className="w-[289px] h-[289px] rounded-full overflow-hidden transform transition-all duration-500 preserve-3d group-hover:scale-105 group-hover:rotate-y-12">
              <img 
                src="/profile.jpg"
                alt="Jibanul Haque"
          ...
          <div className="relative max-w-[400px] bg-gradient-to-br from-blue-50 to-white border-2 border-blue-100/50 px-6 py-4 rounded-2xl shadow-lg">
            ...
            <p className="text-gray-800 text-center relative z-10">
              {displayText}
              {isTyping && (
      ...
      <section id="about-section" className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            {/* Video Side */}
            <div className={`relative h-[500px] overflow-hidden transform transition-all duration-1000 ${
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 mt-3">
                      <p className="text-lg font-semibold text-gray-800">PhD in Computer Science</p>
                      <p className="text-lg font-semibold text-gray-800">MS in Statistical Computing</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-blue-50">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 mt-3">
                      <p className="text-lg font-semibold text-gray-800">BS in Statistics</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="experience-section" className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            {/* Video Side with Learn More Button */}
            <div className="flex flex-col items-center">
              <video
                ...
                muted
                playsInline
                className={`w-full rounded-lg shadow-lg transform transition-all duration-1000 mb-6 ${
